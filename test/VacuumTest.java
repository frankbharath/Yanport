...
public class VacuumTest {
    ...
    public void testIfVacuumGoesOutOfGrid(){
        Vacuum vacuum=new Vacuum(0,0,new Grid(10,10), Orientation.getValueForOrientation('W'));
        ...
        Vacuum vacuum1=new Vacuum(0,0,new Grid(10,10), Orientation.getValueForOrientation('S'));
        exception = assertThrows(RuntimeException.class, () -> vacuum1.executeInstructions("A"));
        assertEquals("Vacuum cleaner cannot move", exception.getMessage());

        Vacuum vacuum2=new Vacuum(9,9,new Grid(10,10), Orientation.getValueForOrientation('N'));
        exception = assertThrows(RuntimeException.class, () -> vacuum2.executeInstructions("A"));
        assertEquals("Vacuum cleaner cannot move", exception.getMessage());

        Vacuum vacuum3=new Vacuum(9,9,new Grid(10,10), Orientation.getValueForOrientation('E'));
    ...
    public void testVacuumForActions(){
        Vacuum vacuum=new Vacuum(5,5,new Grid(10,10), Orientation.getValueForOrientation('N'));
        ...
        vacuum=new Vacuum(0,0,new Grid(10,10), Orientation.getValueForOrientation('N'));
        vacuum.executeInstructions("ADADAGAGA");
        assertEquals(vacuum.getX(), 2);
        assertEquals(vacuum.getY(), 1);
        assertEquals(vacuum.getOrientation(), 'N');

        vacuum=new Vacuum(8,2,new Grid(10,10), Orientation.getValueForOrientation('W'));
        ...
        vacuum=new Vacuum(1,1,new Grid(3,3), Orientation.getValueForOrientation('E'));
